...
{ 11413, 11414, 11415, 1386 };

const uint32 EP_HordeBuffs[4] =
{ 30880, 30683, 30682, 29520 };
...
{
    EP_NPT_N = 2352, EP_NPT_N_A = 2362, EP_NPT_N_H = 2363, EP_NPT_A = 2372, EP_NPT_H = 2373
};
...
{
    EP_CGT_N_A = 2374, EP_CGT_N_H = 2375, EP_CGT_A = 2378, EP_CGT_H = 2379, EP_CGT_N = 2355
};

enum EP_WorldStates
{
    EP_UI_TOWER_SLIDER_DISPLAY = 2426, EP_UI_TOWER_SLIDER_POS = 2427, EP_UI_TOWER_SLIDER_N = 2428,

    EP_UI_TOWER_COUNT_A = 2327, EP_UI_TOWER_COUNT_H = 2328
};

enum EP_Summons
{
    EP_EWT_COMMANDER = 0, EP_EWT_SOLDIER1, EP_EWT_SOLDIER2, EP_EWT_SOLDIER3, EP_EWT_SOLDIER4, EP_PWT_FLIGHTMASTER,
};
...
const uint32 EPTowerPlayerEnterEvents[EP_TOWER_NUM] =
{ 10691, 10699, 10701, 10705 };

const uint32 EPTowerPlayerLeaveEvents[EP_TOWER_NUM] =
{ 10692, 10698, 10700, 10704 };
...
enum EP_TowerStates
{
    EP_TS_N = 1, EP_TS_N_A = 2, EP_TS_N_H = 4, EP_TS_A_P = 8, EP_TS_H_P = 16, EP_TS_A = 32, EP_TS_H = 64
};

// when spawning, pay attention at setting the faction manually!
const creature_type EP_PWT_FlightMaster =
{ 17209, 0, 0, 2987.5f, -3049.11f, 120.126f, 5.75959f };
