...
enum AzureMageSlayerSpells {
	SPELL_ARCANE_EMPOWERMENT = 58469, SPELL_SPELL_LOCK = 30849
};

enum AzureCaptainSpells {
	SPELL_MORTAL_STRIKE = 32736, SPELL_WHIRLWIND_OF_STEEL = 41057
};
...
enum AzureRaiderSpells {
	SPELL_CONCUSSION_BLOW = 52719, SPELL_MAGIC_REFLECTION = 60158
};

enum AzureStalkerSpells {
	SPELL_BACKSTAB = 58471, SPELL_TACTICAL_BLINK = 58470
};
...
enum Spells {
	SPELL_PORTAL_CHANNEL = 58012, SPELL_CRYSTALL_ACTIVATION = 57804
};
...
float FirstPortalWPs[6][3] = { { 1877.670288f, 842.280273f, 43.333591f }, {
		1877.338867f, 834.615356f, 38.762287f }, { 1872.161011f, 823.854309f,
		38.645401f }, { 1864.860474f, 815.787170f, 38.784843f }, { 1858.953735f,
		810.048950f, 44.008759f }, { 1843.707153f, 805.807739f, 44.135197f }
//{1825.736084f, 807.305847f, 44.363785f}
		};

float SecondPortalFirstWPs[9][3] = { { 1902.561401f, 853.334656f, 47.106117f },
		{ 1895.486084f, 855.376404f, 44.334591f }, { 1882.805176f, 854.993286f,
				43.333591f }, { 1877.670288f, 842.280273f, 43.333591f }, {
				1877.338867f, 834.615356f, 38.762287f }, { 1872.161011f,
				823.854309f, 38.645401f }, { 1864.860474f, 815.787170f,
				38.784843f }, { 1858.953735f, 810.048950f, 44.008759f }, {
				1843.707153f, 805.807739f, 44.135197f }
//{1825.736084f, 807.305847f, 44.363785f}
		};

float SecondPortalSecondWPs[8][3] = { { 1929.392212f, 837.614990f, 47.136166f },
		{ 1928.290649f, 824.750427f, 45.474411f }, { 1915.544922f, 826.919373f,
				38.642811f }, { 1900.933960f, 818.855652f, 38.801647f }, {
				1886.810547f, 813.536621f, 38.490490f }, { 1869.079712f,
				808.701538f, 38.689003f }, { 1860.843384f, 806.645020f,
				44.008789f }, { 1843.707153f, 805.807739f, 44.135197f }
//{1825.736084f, 807.305847f, 44.363785f}
		};

float ThirdPortalWPs[8][3] = { { 1934.049438f, 815.778503f, 52.408699f }, {
		1928.290649f, 824.750427f, 45.474411f }, { 1915.544922f, 826.919373f,
		38.642811f }, { 1900.933960f, 818.855652f, 38.801647f }, { 1886.810547f,
		813.536621f, 38.490490f }, { 1869.079712f, 808.701538f, 38.689003f }, {
		1860.843384f, 806.645020f, 44.008789f }, { 1843.707153f, 805.807739f,
		44.135197f }
//{1825.736084f, 807.305847f, 44.363785f}
		};

float FourthPortalWPs[9][3] = { { 1921.658447f, 761.657043f, 50.866741f }, {
		1910.559814f, 755.780457f, 47.701447f }, { 1896.664673f, 752.920898f,
		47.667004f }, { 1887.398804f, 763.633240f, 47.666851f }, { 1879.020386f,
		775.396973f, 38.705990f }, { 1872.439087f, 782.568604f, 38.808292f }, {
		1863.573364f, 791.173584f, 38.743660f }, { 1857.811890f, 796.765564f,
		43.950329f }, { 1845.577759f, 800.681152f, 44.104248f }
//{1827.100342f, 801.605957f, 44.363358f}
		};

float FifthPortalWPs[6][3] = { { 1887.398804f, 763.633240f, 47.666851f }, {
		1879.020386f, 775.396973f, 38.705990f }, { 1872.439087f, 782.568604f,
		38.808292f }, { 1863.573364f, 791.173584f, 38.743660f }, { 1857.811890f,
		796.765564f, 43.950329f }, { 1845.577759f, 800.681152f, 44.104248f }
//{1827.100342f, 801.605957f, 44.363358f}
		};

float SixthPoralWPs[4][3] = { { 1888.861084f, 805.074768f, 38.375790f }, {
		1869.793823f, 804.135804f, 38.647018f }, { 1861.541504f, 804.149780f,
		43.968292f }, { 1843.567017f, 804.288208f, 44.139091f }
//{1826.889648f, 803.929993f, 44.363239f}
		};

const float SaboteurFinalPos1[3][3] = {
		{ 1892.502319f, 777.410767f, 38.630402f }, { 1891.165161f, 762.969421f,
				47.666920f }, { 1893.168091f, 740.919189f, 47.666920f } };
const float SaboteurFinalPos2[3][3] = {
		{ 1882.242676f, 834.818726f, 38.646786f }, { 1879.220825f, 842.224854f,
				43.333641f }, { 1873.842896f, 863.892456f, 43.333641f } };
const float SaboteurFinalPos3[2][3] = {
		{ 1904.298340f, 792.400391f, 38.646782f }, { 1935.716919f, 758.437073f,
				30.627895f } };
...
const float SaboteurFinalPos6[5][3] = {
		{ 1911.437012f, 821.289246f, 38.684128f }, { 1920.734009f, 822.978027f,
				41.525414f }, { 1928.262939f, 830.836609f, 44.668266f }, {
				1929.338989f, 837.593933f, 47.137596f }, { 1931.063354f,
				848.468445f, 47.190434f } };

const Position MovePosition = { 1806.955566f, 803.851807f, 44.363323f, 0.0f };
const Position playerTeleportPosition = { 1830.531006f, 803.939758f, 44.340508f,
		6.281611f };
const Position sinclariOutsidePosition = { 1817.315674f, 804.060608f,
		44.363998f, 0.0f };

class npc_sinclari_vh: public CreatureScript {
public:
	npc_sinclari_vh() :
			CreatureScript("npc_sinclari_vh") {
	}
	...
	bool OnGossipSelect(Player* pPlayer, Creature* pCreature,
		...
		case GOSSIP_ACTION_INFO_DEF + 1:
			...
			CAST_AI(npc_sinclari_vh::npc_sinclariAI, (pCreature->AI()))->uiPhase =
					1;
		...
		case GOSSIP_ACTION_INFO_DEF + 3:
			pPlayer->NearTeleportTo(playerTeleportPosition.GetPositionX(),
					playerTeleportPosition.GetPositionY(),
					playerTeleportPosition.GetPositionZ(),
					playerTeleportPosition.GetOrientation(), true);
			pPlayer->CLOSE_GOSSIP_MENU();
			break;
		}
		return true;
	...
	struct npc_sinclariAI: public ScriptedAI {
		npc_sinclariAI(Creature* pCreature) :
		...
		void Reset() {
			...
			me->GetCreatureListWithEntryInGrid(GuardList, NPC_VIOLET_HOLD_GUARD,
					40.0f);
			if (!GuardList.empty()) {
		...
		void UpdateAI(const uint32 uiDiff) {
			...
			if (uiPhase) {
				if (uiTimer <= uiDiff) {
					...
					case 2: {
						std::list<Creature*> GuardList;
						me->GetCreatureListWithEntryInGrid(GuardList,
						...
						if (!GuardList.empty())
							for (std::list<Creature*>::const_iterator itr =
									...
									++itr) {
								if (Creature* pGuard = *itr) {
									pGuard->RemoveUnitMovementFlag(
											MOVEMENTFLAG_WALKING);
									pGuard->GetMotionMaster()->MovePoint(0,
											MovePosition);
								}
							}
						uiTimer = 6000;
					...
					case 5:
						if (pInstance)
							pInstance->SetData(DATA_MAIN_EVENT_PHASE,
									IN_PROGRESS);
...
public:
	mob_azure_saboteur() :
			CreatureScript("mob_azure_saboteur") {
	}
	...
	struct mob_azure_saboteurAI: public npc_escortAI {
		mob_azure_saboteurAI(Creature *c) :
				npc_escortAI(c) {
		...
		void Reset() {
			if (pInstance && !uiBoss)
				uiBoss =
						pInstance->GetData(DATA_WAVE_COUNT) == 6 ?
								pInstance->GetData(DATA_FIRST_BOSS) :
								pInstance->GetData(DATA_SECOND_BOSS);
			me->SetReactState(REACT_PASSIVE);
		...
		void UpdateAI(const uint32 diff) {
			if (pInstance
					&& pInstance->GetData(DATA_MAIN_EVENT_PHASE) != IN_PROGRESS)
				me->CastStop();
			...
			if (!bHasGotMovingPoints) {
				...
				case 1:
					for (int i = 0; i < 3; i++)
						AddWaypoint(i, SaboteurFinalPos1[i][0],
								SaboteurFinalPos1[i][1],
								SaboteurFinalPos1[i][2], 0);
					me->SetHomePosition(SaboteurFinalPos1[2][0],
							SaboteurFinalPos1[2][1], SaboteurFinalPos1[2][2],
							4.762346f);
					break;
				case 2:
					for (int i = 0; i < 3; i++)
						AddWaypoint(i, SaboteurFinalPos2[i][0],
								SaboteurFinalPos2[i][1],
								SaboteurFinalPos2[i][2], 0);
					me->SetHomePosition(SaboteurFinalPos2[2][0],
							SaboteurFinalPos2[2][1], SaboteurFinalPos2[2][2],
							1.862674f);
					break;
				case 3:
					for (int i = 0; i < 2; i++)
						AddWaypoint(i, SaboteurFinalPos3[i][0],
								SaboteurFinalPos3[i][1],
								SaboteurFinalPos3[i][2], 0);
					me->SetHomePosition(SaboteurFinalPos3[1][0],
							SaboteurFinalPos3[1][1], SaboteurFinalPos3[1][2],
							5.500638f);
					break;
				case 4:
					AddWaypoint(0, SaboteurFinalPos4[0], SaboteurFinalPos4[1],
							SaboteurFinalPos4[2], 0);
					me->SetHomePosition(SaboteurFinalPos4[0],
							SaboteurFinalPos4[1], SaboteurFinalPos4[2],
							3.991108f);
					break;
				case 5:
					AddWaypoint(0, SaboteurFinalPos5[0], SaboteurFinalPos5[1],
							SaboteurFinalPos5[2], 0);
					me->SetHomePosition(SaboteurFinalPos5[0],
							SaboteurFinalPos5[1], SaboteurFinalPos5[2],
							1.100841f);
					break;
				case 6:
					for (int i = 0; i < 5; i++)
						AddWaypoint(i, SaboteurFinalPos6[i][0],
								SaboteurFinalPos6[i][1],
								SaboteurFinalPos6[i][2], 0);
					me->SetHomePosition(SaboteurFinalPos6[4][0],
							SaboteurFinalPos6[4][1], SaboteurFinalPos6[4][2],
							0.983031f);
					break;
				}
		...
		void FinishPointReached() {
			...
			me->DisappearAndDie();
			Creature* pSaboPort = Unit::GetCreature((*me),
					pInstance->GetData64(DATA_SABOTEUR_PORTAL));
			if (pSaboPort)
...
public:
	npc_teleportation_portal_vh() :
			CreatureScript("npc_teleportation_portal_vh") {
	}
	...
	struct npc_teleportation_portalAI: public ScriptedAI {
		npc_teleportation_portalAI(Creature *c) :
				ScriptedAI(c), listOfMobs(me) {
			pInstance = c->GetInstanceScript();
		...
		void UpdateAI(const uint32 diff) {
			...
			case 0:
				if (!bPortalGuardianOrKeeperOrEliteSpawn) {
					if (uiSpawnTimer <= diff) {
						...
						for (uint8 i = 0; i < k; ++i) {
							uint32 entry = RAND(CREATURE_AZURE_CAPTAIN,
									CREATURE_AZURE_RAIDER,
									CREATURE_AZURE_STALKER,
									CREATURE_AZURE_SORCEROR);
							DoSummon(entry, me, 2.0f, 20000,
			...
			case 1:
				if (uiSpawnTimer <= diff) {
					if (bPortalGuardianOrKeeperOrEliteSpawn) {
						uint8 k =
								pInstance->GetData(DATA_WAVE_COUNT) < 12 ?
										3 : 4;
						for (uint8 i = 0; i < k; ++i) {
							uint32 entry = RAND(CREATURE_AZURE_INVADER_1,
						...
						bPortalGuardianOrKeeperOrEliteSpawn = true;
						uint32 entry = RAND(CREATURE_PORTAL_GUARDIAN,
		...
		void JustDied(Unit* /*killer*/) {
			if (pInstance)
				pInstance->SetData(DATA_WAVE_COUNT,
						pInstance->GetData(DATA_WAVE_COUNT) + 1);
		}
...
public:
	...
	void WaypointReached(uint32 uiPointId) {
		...
		case 0:
			...
			break;
		case 1:
			if ((uiPointId == 8 && secondPortalRouteID == 0)
					|| (uiPointId == 7 && secondPortalRouteID == 1))
				CreatureStartAttackDoor();
			break;
		case 2:
			if (uiPointId == 7)
	...
	void UpdateAI(const uint32) {
		...
		if (!bHasGotMovingPoints) {
			...
			case 0:
				for (int i = 0; i < 6; i++)
					AddWaypoint(i, FirstPortalWPs[i][0] + irand(-1, 1),
							FirstPortalWPs[i][1] + irand(-1, 1),
							FirstPortalWPs[i][2] + irand(-1, 1), 0);
				me->SetHomePosition(FirstPortalWPs[5][0], FirstPortalWPs[5][1],
						FirstPortalWPs[5][2], 3.149439f);
				break;
			case 1:
				...
				case 0:
					for (int i = 0; i < 9; i++)
						AddWaypoint(i,
								SecondPortalFirstWPs[i][0] + irand(-1, 1),
								SecondPortalFirstWPs[i][1] + irand(-1, 1),
								SecondPortalFirstWPs[i][2], 0);
					me->SetHomePosition(
							SecondPortalFirstWPs[8][0] + irand(-1, 1),
							SecondPortalFirstWPs[8][1] + irand(-1, 1),
							SecondPortalFirstWPs[8][2] + irand(-1, 1),
							3.149439f);
					break;
				case 1:
					for (int i = 0; i < 8; i++)
						AddWaypoint(i,
								SecondPortalSecondWPs[i][0] + irand(-1, 1),
								SecondPortalSecondWPs[i][1] + irand(-1, 1),
								SecondPortalSecondWPs[i][2], 0);
					me->SetHomePosition(SecondPortalSecondWPs[7][0],
							SecondPortalSecondWPs[7][1],
							SecondPortalSecondWPs[7][2], 3.149439f);
					break;
				}
				break;
			case 2:
				for (int i = 0; i < 8; i++)
					AddWaypoint(i, ThirdPortalWPs[i][0] + irand(-1, 1),
							ThirdPortalWPs[i][1] + irand(-1, 1),
							ThirdPortalWPs[i][2], 0);
				me->SetHomePosition(ThirdPortalWPs[7][0], ThirdPortalWPs[7][1],
						ThirdPortalWPs[7][2], 3.149439f);
				break;
			case 3:
				for (int i = 0; i < 9; i++)
					AddWaypoint(i, FourthPortalWPs[i][0] + irand(-1, 1),
							FourthPortalWPs[i][1] + irand(-1, 1),
							FourthPortalWPs[i][2], 0);
				me->SetHomePosition(FourthPortalWPs[8][0],
						FourthPortalWPs[8][1], FourthPortalWPs[8][2],
						3.149439f);
				break;
			case 4:
				for (int i = 0; i < 6; i++)
					AddWaypoint(i, FifthPortalWPs[i][0] + irand(-1, 1),
							FifthPortalWPs[i][1] + irand(-1, 1),
							FifthPortalWPs[i][2], 0);
				me->SetHomePosition(FifthPortalWPs[5][0], FifthPortalWPs[5][1],
						FifthPortalWPs[5][2], 3.149439f);
				break;
			case 5:
				for (int i = 0; i < 4; i++)
					AddWaypoint(i, SixthPoralWPs[i][0] + irand(-1, 1),
							SixthPoralWPs[i][1] + irand(-1, 1),
							SixthPoralWPs[i][2], 0);
				me->SetHomePosition(SixthPoralWPs[3][0], SixthPoralWPs[3][1],
						SixthPoralWPs[3][2], 3.149439f);
				break;
			}
			SetDespawnAtEnd(false);
			Start(true, true);
	...
	void JustDied(Unit * /*unit*/) {
		if (Creature* portal = Unit::GetCreature((*me), pInstance->GetData64(DATA_TELEPORTATION_PORTAL)))
			CAST_AI(npc_teleportation_portal_vh::npc_teleportation_portalAI, portal->AI())->SummonedMobDied(
					me);
		if (pInstance)
...
public:
	mob_azure_invader() :
			CreatureScript("mob_azure_invader") {
	}
	...
	struct mob_azure_invaderAI: public violet_hold_trashAI {
		mob_azure_invaderAI(Creature *c) :
				violet_hold_trashAI(c) {
			pInstance = c->GetInstanceScript();
		}
...
public:
	mob_azure_binder() :
			CreatureScript("mob_azure_binder") {
	}
		...
		void UpdateAI(const uint32 diff) {
			...
			if (me->GetEntry() == CREATURE_AZURE_BINDER_1) {
				if (uiArcaneExplosionTimer <= diff) {
					DoCast(
							DUNGEON_MODE(SPELL_ARCANE_EXPLOSION,
				...
				if (uiArcainBarrageTimer <= diff) {
					...
					if (pTarget)
						DoCast(
								pTarget,
								DUNGEON_MODE(SPELL_ARCANE_BARRAGE,
...
public:
	mob_azure_mage_slayer() :
			CreatureScript("mob_azure_mage_slayer") {
	}
	...
	struct mob_azure_mage_slayerAI: public violet_hold_trashAI {
		mob_azure_mage_slayerAI(Creature *c) :
				violet_hold_trashAI(c) {
			pInstance = c->GetInstanceScript();
		}
...
public:
	mob_azure_raider() :
			CreatureScript("mob_azure_raider") {
	}
...
public:
	mob_azure_stalker() :
			CreatureScript("mob_azure_stalker") {
	}
	...
	struct mob_azure_stalkerAI: public violet_hold_trashAI {
		mob_azure_stalkerAI(Creature *c) :
				violet_hold_trashAI(c) {
			pInstance = c->GetInstanceScript();
		}
		...
		void UpdateAI(const uint32 diff) {
			...
			if (!TacticalBlinkCasted) {
				if (uiTacticalBlinkTimer <= diff) {
					Unit* pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 40,
							true);
					if (pTarget)
				...
				if (uiBackstabTimer <= diff) {
					Unit* pTarget = SelectTarget(SELECT_TARGET_NEAREST, 0, 10,
							true);
...
public:
	mob_azure_spellbreaker() :
			CreatureScript("mob_azure_spellbreaker") {
	}

	struct mob_azure_spellbreakerAI: public violet_hold_trashAI {
		mob_azure_spellbreakerAI(Creature* c) :
				violet_hold_trashAI(c) {
			pInstance = c->GetInstanceScript();
		}
		...
		void UpdateAI(const uint32 diff) {
			...
			if (me->GetEntry() == CREATURE_AZURE_SPELLBREAKER_1) {
				if (uiArcaneBlastTimer <= diff) {
					...
					if (pTarget)
						DoCast(
								pTarget,
								DUNGEON_MODE(SPELL_ARCANE_BLAST,
			...
			if (me->GetEntry() == CREATURE_AZURE_SPELLBREAKER_2) {
				...
				if (uiConeOfColdTimer <= diff) {
					DoCast(
							DUNGEON_MODE(SPELL_CONE_OF_COLD,
...
public:
	mob_azure_captain() :
			CreatureScript("mob_azure_captain") {
	}
	...
	struct mob_azure_captainAI: public violet_hold_trashAI {
		mob_azure_captainAI(Creature *c) :
				violet_hold_trashAI(c) {
			pInstance = c->GetInstanceScript();
		}
...
public:
	mob_azure_sorceror() :
			CreatureScript("mob_azure_sorceror") {
	}
	...
	struct mob_azure_sorcerorAI: public violet_hold_trashAI {
		mob_azure_sorcerorAI(Creature *c) :
				violet_hold_trashAI(c) {
			pInstance = c->GetInstanceScript();
		}
		...
		void UpdateAI(const uint32 diff) {
			...
			if (uiArcaneStreamTimer <= diff) {
				...
				if (pTarget)
					DoCast(
							pTarget,
							DUNGEON_MODE(SPELL_ARCANE_STREAM,
			...
			if (uiManaDetonationTimer <= diff && uiArcaneStreamTimer >= 1500
				...
				DoCast(
						DUNGEON_MODE(SPELL_MANA_DETONATION,
