    ...
    public:
        ...
        class spell_dreamwalker_summoner_SpellScript : public SpellScript
        {
            ...
            void HandleForceCast(SpellEffIndex effIndex)
            {
                ...
                GetHitUnit()->CastSpell(GetCaster(), GetSpellProto()->Effects[effIndex].TriggerSpell, true, NULL, NULL, GetCaster()->GetInstanceScript()->GetData64(DATA_VALITHRIA_LICH_KING));
            }
        ...
        class spell_dreamwalker_twisted_nightmares_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                if (InstanceScript* instance = GetHitUnit()->GetInstanceScript())
                    GetHitUnit()->CastSpell((Unit*)NULL, GetSpellProto()->Effects[effIndex].TriggerSpell, true, NULL, NULL, instance->GetData64(DATA_VALITHRIA_DREAMWALKER));
            }
