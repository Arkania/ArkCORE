...
const Position ToCCommonLoc[] = { { 559.257996f, 90.266197f, 395.122986f, 0 }, //  0 Barrent
...
const Position JaraxxusLoc[] = { { 508.104767f, 138.247345f, 395.128052f, 0 }, // 0 - Fizzlebang start location
...
const Position FactionChampionLoc[] = { { 514.231f, 105.569f, 418.234f, 0 }, //  0 - Horde Initial Pos 0
...
const Position LichKingLoc[] = { { 563.549f, 152.474f, 394.393f, 0 }, // 0 - Lich king start
		{ 563.547f, 141.613f, 393.908f, 0 }, // 1 - Lich king end
		};

const Position AnubarakLoc[] = { { 787.932556f, 133.289780f, 142.612152f, 0 }, // 0 - Anub'arak start location
...
enum euiWorldStates {
	UPDATE_STATE_UI_SHOW = 4390, UPDATE_STATE_UI_COUNT = 4389,
};
