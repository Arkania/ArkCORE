...
public:
    ...
    {
        if(player->HasAuraEffect(SPELL_TWILIGHT_SHIFT_ENTER,0))
        {
        ...
        {
            player->RemoveAurasDueToSpell(SPELL_TWILIGHT_TORMENT_SHADOW);
            player->RemoveAurasDueToSpell(SPELL_TWILIGHT_TORMENT_SHAFIR);
