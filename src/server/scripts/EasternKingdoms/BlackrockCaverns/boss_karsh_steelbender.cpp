...
enum Spells
{
    SPELL_QUECKSILVER_ARMOR = 75842, SPELL_SUPERHEATED_QUECKSILVER_ARMOR = 75846,

    SPELL_HEAT_WAVE = 63677, SPELL_BURNING_METAL = 76002, SPELL_CLEAVE = 845, SPELL_LAVA_SPOUT = 76007,
...
enum Events
{
    EVENT_CLEAVE = 1, EVENT_CHECK_ARMOR_STATE = 2, EVENT_LAVA_POOL = 3,
};
...
public:
    boss_karsh_steelbender () :
            CreatureScript("boss_karsh_steelbender")
    {
    }
    ...
    {
        boss_karsh_steelbenderAI (Creature* creature) :
                ScriptedAI(creature)
        {
