...
{
    // Corlas Spells
    SPELL_EVOLUTION = 75697, SPELL_TWILIGHT_EVOLUTION = 75732,

    SPELL_AURA_OF_ACCELERATION = 75817, SPELL_DARK_COMMAND = 75823,

    SPELL_KNEELING_IN_SUPPLICATION = 75608, SPELL_DRAIN_ESSENCE_CHANNELING = 75645,

    SPELL_NETHERESSENCE_AURA = 75649, SPELL_NETHERESSENCE_VISUAL = 75650,

    // Envolved Twilight Zealot & Twilight Drakonid
    SPELL_FORCE_BLAST = 76522, SPELL_GRAVITY_STRIKE = 76561, SPELL_GRIEVOUS_WHIRL = 93658, SPELL_SHADOW_STRIKE = 66134,
};
...
enum Events
{
    ...
    EVENT_FORCE_BLAST = 2, EVENT_GRAVITY_STRIKE = 3, EVENT_GRIEVOUS_WHIRL = 4, EVENT_SHADOW_STRIKE = 5,
};

enum Actions
{
    ACTION_TRIGGER_START_CHANNELING = 1, ACTION_TRIGGER_STOP_CHANNELING = 2,
};
...
public:
    boss_corla_herald_of_twilight () :
            CreatureScript("boss_corla_herald_of_twilight")
    {
    }
    ...
    {
        boss_corla_herald_of_twilightAI (Creature* creature) :
                ScriptedAI(creature)
        {
...
public:
    mob_twilight_zealot () :
            CreatureScript("mob_twilight_zealot")
    {
    }
    ...
    {
        mob_twilight_zealotAI (Creature* creature) :
                ScriptedAI(creature), Intialized(false)
        {
        }
...
{
public:
    mob_corla_netheressence_trigger () :
            CreatureScript("mob_corla_netheressence_trigger")
    {
    }
    ...
    {
        mob_corla_netheressence_triggerAI (Creature* creature) :
                ScriptedAI(creature)
        {
            channelTarget = NULL;
            lastTarget = NULL;
