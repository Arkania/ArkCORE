...
public:
    npc_custodian_of_time() :
            CreatureScript("npc_custodian_of_time") {
    }
    ...
    struct npc_custodian_of_timeAI: public npc_escortAI {
        npc_custodian_of_timeAI(Creature *c) :
                npc_escortAI(c) {
        }
        ...
        void MoveInLineOfSight(Unit *who) {
            ...
            if (who->GetTypeId() == TYPEID_PLAYER) {
                if (who->HasAura(34877)
                        && CAST_PLR(who)->GetQuestStatus(10277)
...
public:
    npc_marin_noggenfogger() :
            CreatureScript("npc_marin_noggenfogger") {
    }
...
public:
    ...
    bool OnGossipHello(Player* pPlayer, Creature* pCreature) {
        ...
        if (pPlayer->GetQuestStatus(10279) == QUEST_STATUS_INCOMPLETE
                || pPlayer->GetQuestRewardStatus(10279)) {
...
public:
    ...
    struct npc_OOX17AI: public npc_escortAI {
        ...
        void WaypointReached(uint32 i) {
            ...
            switch (i) {
            case 23:
                me->SummonCreature(SPAWN_FIRST, -8350.96f, -4445.79f, 10.10f,
                        6.20f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                me->SummonCreature(SPAWN_FIRST, -8355.96f, -4447.79f, 10.10f,
                        6.27f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                me->SummonCreature(SPAWN_FIRST, -8353.96f, -4442.79f, 10.10f,
                        6.08f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                DoScriptText(SAY_OOX_AMBUSH, me);
                break;

            case 56:
                me->SummonCreature(SPAWN_SECOND_1, -7510.07f, -4795.50f, 9.35f,
                        6.06f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                me->SummonCreature(SPAWN_SECOND_2, -7515.07f, -4797.50f, 9.35f,
                        6.22f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                me->SummonCreature(SPAWN_SECOND_2, -7518.07f, -4792.50f, 9.35f,
                        6.22f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                DoScriptText(SAY_OOX_AMBUSH, me);
...
public:
    ...
    struct npc_toogaAI: public FollowerAI {
        npc_toogaAI(Creature* pCreature) :
            ...
            if (!UpdateVictim()) {
                    ...
                    if (m_uiPostEventTimer <= uiDiff) {
                        ...
                        case 6:
                            ...
                            me->GetMotionMaster()->MovePoint(POINT_ID_TO_WATER,
                                    m_afToWaterLoc[0], m_afToWaterLoc[1],
                                    m_afToWaterLoc[2]);
                            break;
                        }
                ...
                //...we are doing regular speech check
                    ...
                    if (m_uiCheckSpeechTimer <= uiDiff) {
                        ...
                        if (urand(0, 9) > 8)
                            DoScriptText(
                                    RAND(SAY_TOOG_THIRST, SAY_TOOG_WORRIED),
                                    me);
                    } else
