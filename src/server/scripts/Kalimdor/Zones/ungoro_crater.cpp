...
public:
    ...
    struct npc_ameAI: public npc_escortAI {
        ...
        void WaypointReached(uint32 i) {
            ...
            switch (i) {
            case 19:
                me->SummonCreature(ENTRY_STOMPER, -6391.69f, -1730.49f,
                        -272.83f, 4.96f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                        25000);
            ...
            case 28:
                ...
                break;
            case 38:
                me->SummonCreature(ENTRY_TARLORD, -6370.75f, -1382.84f,
                        -270.51f, 6.06f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                        25000);
                DoScriptText(SAY_AGGRO2, me, pPlayer);
                break;
            case 49:
                me->SummonCreature(ENTRY_TARLORD1, -6324.44f, -1181.05f,
                        -270.17f, 4.34f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                        25000);
...
public:
    ...
    struct npc_ringoAI: public FollowerAI {
        npc_ringoAI(Creature* pCreature) :
        ...
        void SetFaint() {
            if (!HasFollowState(STATE_FOLLOW_POSTEVENT)) {
                ...
                DoScriptText(
                        RAND(SAY_FAINT_1, SAY_FAINT_2, SAY_FAINT_3,
                                SAY_FAINT_4), me);
            }
        ...
        void ClearFaint() {
            ...
            DoScriptText(RAND(SAY_WAKE_1, SAY_WAKE_2, SAY_WAKE_3, SAY_WAKE_4),
                    me);
