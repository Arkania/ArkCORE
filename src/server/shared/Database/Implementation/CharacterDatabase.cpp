...
void CharacterDatabaseConnection::DoPrepareStatements() {
    ...
    PREPARE_STATEMENT(
            CHAR_ADD_GUILD,
            "INSERT INTO guild (guildid, name, leaderguid, info, motd, createdate, EmblemStyle, EmblemColor, BorderStyle, BorderColor, BackgroundColor, BankMoney, xp, todayXP, XPCap, level) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            CONNECTION_ASYNC)
