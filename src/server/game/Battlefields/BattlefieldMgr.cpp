/*
* Copyright (C) 2011-2012 Project ArkCore <http://www.arkania.net/>
...
void BattlefieldMgr::InitBattlefield()
{
    ...
    {
        sLog->outString();
        sLog->outError("Battlefield : WG initialization failed.");
        delete pBf;
    }
    else
    {
        ...
        sLog->outString();
        sLog->outString("Battlefield : WG initialization complete normal.");
    }
}
