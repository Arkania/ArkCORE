...
void InitOpcodeTable ()
{
    ...
    OPCODE( CMSG_GUILD_UPDATE_PARTY_STATE, TATUS_LOGGEDIN, PROCESS_INPLACE, &WorldSession::HandleGuildPartyStateUpdate);
    OPCODE( CMSG_GUILD_QUERY_NEWS, TATUS_LOGGEDIN, PROCESS_INPLACE, &WorldSession::HandleGuildQueryNews);
