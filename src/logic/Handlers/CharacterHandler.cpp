...
void WorldSession::HandleCharDeleteOpcode (WorldPacket & recv_data)
{
    ...
    // prevent deleting other players' characters using cheating logicPCH.h
...
void WorldSession::HandlePlayerLogin (LoginQueryHolder * holder)
{
    ...
    // "GetAccountId() == db stored account id" checked in LoadFromDB (prevent login not own character using cheating logicPCH.h)
