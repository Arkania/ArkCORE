...
insert  into `worldstates`(`entry`,`value`,`comment`) values (31001,0,'WG war status'),(31002,0,'WG clock'),(31003,0,'WG Fortress Defender'),(31004,0,'WG TEMP Battle Control Faction');
