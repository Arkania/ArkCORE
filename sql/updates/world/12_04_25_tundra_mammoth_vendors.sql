...
ALTER TABLE `vehicle_accessory` ADD `summontype` TINYINT( 1 ) NOT NULL DEFAULT '0';
DELETE FROM `vehicle_accessory` WHERE `entry` IN (32640, 32633);
INSERT INTO `vehicle_accessory` (`entry`, `accessory_entry`, `seat_id`, `minion`, `description`, summontype) VALUES
